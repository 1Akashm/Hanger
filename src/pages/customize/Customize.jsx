...
import { CustomizationDetails } from './customizeShoe'
  ...
  return (
    <>
      ...
      <div className='container-shoe'>
        {
          CustomizationDetails.map((detail) => <div key={detail.id} className='container-inside-customize'>
            <img src={detail.image} alt="Customized Shoes" className='customize-img' />
